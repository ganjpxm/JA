...
public class VudroidPdfActivity extends JOneActivity implements DecodingProgressListener, CurrentPageListener
{
    ...
    {
    	setContentView(R.layout.vudroid_pdf);
        ...
        final FrameLayout frameLayout = (FrameLayout) findViewById(R.id.document_fl);
